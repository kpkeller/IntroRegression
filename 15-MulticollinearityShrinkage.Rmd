...
`lm.ridge()` function from the `MASS` package performs ridge regression

* Requires user-provided `lambda` values
* Standardizes $x$'s automatically
* Has accompanying `plot` and `coef` functions

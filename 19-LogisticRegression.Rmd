...
In logistic regression, parameters ($\beta$'s) are estimated via maximum likelihood. The details of this procedure are covered in Section \@ref(sec:logisticestimation).

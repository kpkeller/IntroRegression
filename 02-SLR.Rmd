...
```{example }
In Example \@ref(exm:penguin-flip-mass-question), we introduced data on penguin flipper length and body mass. We could seek the best-fitting straight line for this data:
```
...
We will expand upon these sentences in Examples \@ref(exm:peng-lm-intro) and \@ref(peng-lm-intro-inference).

...
On the other hand, the predictor variables can be continuous or categorical. In Simple Linear Regression (Chapter \@ref(sec:slr)), there is only one continuous predictor variable. But in general, the predictors can be any combination of variable types, including interactions (Section \@ref(sec:indinter)) and non-linear transformations (Section \@ref(sec:transform)).

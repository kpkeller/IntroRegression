...
The slope parameter $\beta_1$ is unchanged by this reparameterization. The model inference--hypothesis tests and confidence intrevals--are not changed by centering the $x$ variable.
...
As expected, thge slope is the same as the uncentered model. 
